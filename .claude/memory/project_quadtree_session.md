...
- **Notebook generator** at [scripts/build_quadtree_notebook.py](file:///home/zagreus/nj_sandy_sfincs/scripts/build_quadtree_notebook.py). Surgically rewrites the regular-grid notebook (`notebooks/sfincs-asbury-sandy.ipynb`) into [notebooks/sfincs-asbury-sandy-quadtree.ipynb](file:///home/zagreus/nj_sandy_sfincs/notebooks/sfincs-asbury-sandy-quadtree.ipynb). Idempotent — rerun anytime. **All workarounds are baked in** as of session end: SnapWave-mask flip, ds=30° fill, ERA5 offshore-only filter, quadtree_infiltration call, sfincs.inp post-write strip of orphan infiltration keys.
